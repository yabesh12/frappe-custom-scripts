...
# URL to open
url_to_open = "https://erpv4.deepsense.co.in/"  
...
try:
    ...
    browser.get("https://erpv4.deepsense.co.in/app/supplier")
    ...
    for url in valid_urls:
        ...
        # Wait for the "More Information" section to load
        time.sleep(2)  # Wait for 2 seconds
        ...
        custom_auto_field_input.send_keys(f"SUPP-0000{input_no}")
        time.sleep(2)  # Wait for 2 seconds

        # Use ActionChains to send Ctrl+Enter
